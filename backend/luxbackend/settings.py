...
ALLOWED_HOSTS = os.environ.get('DJANGO_ALLOWED_HOSTS', 'localhost,127.0.0.1,192.168.0.3').split(',')
...
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER', 'careers@luxmorai.com')
